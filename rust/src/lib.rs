//! Windissect-generated Rust FFI bindings for NotificationControllerPS.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "6511CAEBBBA20E0D0B4870571A3EA8EB";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1303495306;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 29] = [78, 111, 116, 105, 102, 105, 99, 97, 116, 105, 111, 110, 67, 111, 110, 116, 114, 111, 108, 108, 101, 114, 80, 83, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1303495306 { return 0; }
